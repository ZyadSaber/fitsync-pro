...
interface CoachPromoteDialogProps {
  platformUsers?: PlatformUser[];
}

export default function CoachPromoteDialog({ platformUsers = [] }: CoachPromoteDialogProps) {
  ...
  const { promoteCoach } = useCoachesMutations();
  ...
  const handlePromote = (profileId: string) => {
    promoteCoach.mutate(profileId, { onSuccess: handleClose });
  };
              ...
              filtered.map((user, idx) => (
                ...
                >
                  ...
                  <Button
                    ...
                    isLoading={promoteCoach.isPending && promoteCoach.variables === user.id}
