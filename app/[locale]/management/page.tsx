              ...
              >
                <span
                  style={{
                    ...
                    color: s.type === "coach" ? "#6D28D9" : "#475569",
                    flexShrink: 0,
                  }}
                >
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div className="fs-mono" style={{ fontSize: 10, color: "var(--muted)", marginTop: 2 }}>
                    {t.members} members · health{" "}
                    <span style={{ color: t.health === "good" ? "var(--green)" : "var(--amber)", fontWeight: 600 }}>
                      {t.health}
                    </span>
                  </div>
                </div>
                <span className={`fs-badge ${t.days <= 3 ? "expired" : "pending"}`}>
                  <span className="dot" />
                  {t.days}d
                </span>
              </div>
            ...
            >
              <span
                style={{
                  width: 4,
                  height: 32,
                  background: inc.sev === "red" ? "var(--red)" : "var(--amber)",
                  borderRadius: 2,
                  flexShrink: 0,
                }}
              />
