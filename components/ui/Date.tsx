...
export function DatePicker({
    ...
    return (
        <div className={cn("space-y-1", containerClassName)}>
            {(Icon || label) && <Label className="text-xs uppercase font-black tracking-widest text-muted-foreground flex items-center gap-2">
            ...
            <Popover>
                <PopoverTrigger asChild>
                    <Button
                        variant="outline"
                        data-empty={!value}
                        className={cn("w-full justify-between text-left font-normal data-[empty=true]:text-muted-foreground rounded-xl h-10", className)}
                    >
                        {value ? (
                ...
                <PopoverContent className="w-auto p-0 flex divide-x divide-border overflow-hidden rounded-xl shadow-xl border-none" align="start">
                    ...
                    {showTime && (
                        <div className="flex flex-col w-32 divide-y divide-border">
                            <div className="p-2 flex items-center gap-2 justify-center bg-accent/30">
                            ...
                            <div className="flex h-60 divide-x divide-border">
                                <ScrollArea className="w-14 h-full">
                                    <div className="flex flex-col p-1 pt-1.5">
                                        {Array.from({ length: 24 }).map((_, i) => (
                                            <Button
                                                ...
                                                size="sm"
                                                className={cn(
                                                    "h-7 w-full text-xs font-bold rounded-md mb-0.5",
